...
if ($('.landing-testimonial-carousel')) {
  $('.landing-testimonial-carousel').slick({
    slidesToShow: 2,
    infinite: false,
    prevArrow: '<button type="button" class="slick-nav-btn"><img src="../../../../assets/FE/assets/images/Arrow_L@2x.svg"></button>',
    nextArrow: '<button type="button" class="slick-nav-btn"><img src="../../../../assets/FE/assets/images/Arrow_R@2x.svg"></button>',
